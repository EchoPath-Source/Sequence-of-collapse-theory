...
| ID | Title / Track | Link | Status | Purpose |
|---|---|---|---|---|
| SOC-RC-01 | SPARC Age-Dependent Rotation Curves & Memory Field | https://osf.io/z3wct | `pre-registered / in progress` | Tests whether galaxy formation-history or age proxies correlate with inferred missing-mass / dark-residual structure. |
| CGDS-01 / SOC-MZI-01 | Consciousness-Gated Double-Slit Experiment | https://osf.io/mxt7h | `pre-registered / ready for implementation` | Tests whether conscious access completes collapse beyond physical interaction, decoherence, or machine-only measurement. |
...
| P7 | Observer-state may modulate decoherence/visibility as an additive dephasing channel. | Quantum foundations / MZI | `lambda_eff = lambda_env + lambda_c A(t)` with measurable visibility/coherence shift under controlled observer-state conditions. | `pre-registered / proposed` | Blinded MZI tests show no observer-state-dependent visibility or coherence shift under preregistered conditions. | See CGDS-01 / SOC-MZI-01: https://osf.io/mxt7h and `experiments/quantum/SOC-CGDS-01_Consciousness_Gated_Double_Slit.md`. |
...
| SPARC inner/outer derived split dataset | `observations/sparc/data/sparc_wise_inner_outer_fdm_split.csv` | Derived galaxy-level split table for reproducing radial-decomposition summaries. |
...
| CGDS-01 preregistration note | `experiments/quantum/SOC-CGDS-01_Consciousness_Gated_Double_Slit.md` | OSF-linked adversarial test of conscious-access collapse claims. |
...
6. Implement or partner for CGDS-01 / SOC-MZI-01 observer-access test.
